 ...
 * Author: HOME
 *
 * Created on May 20, 2023, 12:39 PM
 */
...
int main(int argc, char** argv) {
    ...
    char datos[20];
     ...
     while (1) {
        ...
        voltaje = (adcValue*5.0)/1023;
        POS_CURSOR(2,0);
        ESCRIBE_MENSAJE("VOLTAJE:");
        convierte(voltaje);
        ...
        ESCRIBE_MENSAJE("VOLTAJE1:");
        ESCRIBE_MENSAJE(datos);
        ESCRIBE_MENSAJE("V");
        
        __delay_ms(100);    // RETARDO de 100 MS ENTRE CADA LECTURA DEL ADC
    }   
    return (EXIT_SUCCESS);
}
